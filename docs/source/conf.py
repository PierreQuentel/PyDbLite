...
issuetracker = 'github'
issuetracker_project = 'PierreQuentel/PyDbLite'
...
project = u'PyDbLite'
copyright = u'2015, Pierre Quentel, Bendik Rønning Opstad'
...
version = None  # Fetched from pydblite
...
release = '%s %s' % (version, version_info)
